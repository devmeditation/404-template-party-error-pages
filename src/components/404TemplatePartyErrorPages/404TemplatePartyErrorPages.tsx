import styles from './404TemplatePartyErrorPages.module.scss';

export function _404TemplatePartyErrorPages() {
  return (
    <>
      <section className={styles.containerErro404Page1}>
        <div className={styles.container}>
          <p className={styles.textA}>Pagina não encontrada</p>
          <p className={styles.textB}>404</p>
          <a className={styles.textC} href="/home">Retorne ao início </a>
          <svg className="page-not-found" viewBox="0 0 1280 1024">
            <title>Pagina não encontrada</title>
            {/* <g className={`${styles.hide} ${styles.triDots}`}>
            ...
            <g className={`${styles.hide} ${styles.spinCircles}`}>
              <path d="M776.3,403.3A151,151,0,0,1,989.8,189.8" style={{fill: 'none', stroke: '#086b04', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M989.8,189.8A151,151,0,0,1,776.3,403.3" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
              <path d="M786.9,392.7c-53-53-52.8-138.9.3-192.1s139.1-53.2,192.1-.3" style={{fill: 'none', stroke: '#06b300', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M979.2,200.4c53,53,52.8,138.9-.3,192.1s-139.1,53.2-192.1.3" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
              <path d="M797.5,382.1c-46.9-46.9-46.7-123.3.6-170.6s123.6-47.5,170.6-.6" style={{fill: 'none', stroke: '#06b300', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M968.6,211c46.9,46.9,46.7,123.3-.6,170.6s-123.6,47.5-170.6.6" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
              <path d="M808.1,371.5c-40.9-40.9-40.6-107.7.8-149.1s108.1-41.8,149.1-.8" style={{fill: 'none', stroke: '#06b300', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M958,221.6c40.9,40.9,40.6,107.7-.8,149.1s-108.1,41.8-149.1.8" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
              <path d="M818.7,360.9c-34.9-34.9-34.4-92,1.1-127.6s92.7-36,127.6-1.1" style={{fill: 'none', stroke: '#06b300', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M947.4,232.2c34.9,34.9,34.4,92-1.1,127.6s-92.7,36-127.6,1.1" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
              <path d="M829.3,350.3c-28.9-28.9-28.3-76.4,1.4-106.1s77.2-30.3,106.1-1.4" style={{fill: 'none', stroke: '#06b300', strokeMiterlimit: 10, strokeWidth: '8px'}} />
              <path d="M936.8,242.8c28.9,28.9,28.3,76.4-1.4,106.1s-77.2,30.3-106.1,1.4" style={{fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px'}} />
            </g>
            
            <g className={`${styles.hide} ${styles.bigWhiteCircle}`}>
              <circle cx="644" cy="482" r="277" />
            </g>

            {/* <g className={`${styles.hide} ${styles.growCircles}`}>
              <circle cx="940" cy="523" r="27" style={{fill: '#ffe029'}} />
              <circle cx="708.5" cy="217.6" r="14.5" transform="translate(-21.2 87.8) rotate(-7)" style={{fill: '#0300b3'}} />
              <circle cx="725.5" cy="755.6" r="14.5" transform="translate(-86.5 93.8) rotate(-7)" style={{fill: '#080404'}} />
              <circle cx="446.9" cy="181.6" r="16.5" transform="translate(-18.8 55.7) rotate(-7)" style={{fill: '#0300b3'}} />
              <circle cx="314.9" cy="348.6" r="16.5" transform="translate(-40.1 40.9) rotate(-7)" style={{fill: '#ff7300'}} />
              <circle cx="682.6" cy="187.5" r="7.5" transform="translate(-17.7 84.4) rotate(-7)" style={{fill: '#fd0000'}} />
            ...
            <g className={styles.box}>
              <polygon className="main-container" points="364.4 328.1 888.1 292.8 889.1 635 453.7 698.2 364.4 328.1" style={{fill: '#fff', stroke: '#046d0a', strokeMiterlimit: 10, strokeWidth: '24px'}} />
            ...
            <g className={`${styles.hide} ${styles.bottomTriangles}`}>
              <path d="M646.6,741.1,476.8,822.7a8.6,8.6,0,0,1-12.3-8.4l14.3-187.9c.5-6.2,8.4-10,13.5-6.5L647.8,726.2a8.6,8.6,0,0,1-1.1,14.9ZM482.8,800.6,625.7,732,494.8,642.5Z" style={{fill: '#046d0a'}} />
              <path className={styles.endTriangle} d="M538.3 732.9l-27.9-104.5L687 671l-138.7 91.9z" />
              <path className={styles.startTriangle} d="M477 803l10.7-159L620 734l-144 69z" />
            </g>

            <g className={styles.squiggles}>
              <g className={styles.squiggleBottom}>
                <path 
                  className={styles.squiggleBottomFull} 
                ...
                />
                <g className={styles.dotsBottom}>
                  <circle cx="802.6" cy="727.5" r="1.6" />
                  <circle cx="799.1" cy="734.8" r="1.5" />
                  <circle cx="809.6" cy="734.3" r="1.6" />
                  <circle cx="807.1" cy="742.3" r="1.6" />
                  <circle cx="814.7" cy="743.8" r="1.6" />
                  <circle cx="810.3" cy="752.5" r="1.4" />
                  <circle cx="818.4" cy="753" r="1.6" />
                  <circle cx="816.3" cy="761.8" r="1.6" />
                  <circle cx="825.5" cy="760.1" r="1.6" />
                  <circle cx="834.1" cy="755.3" r="1.6" />
                  <circle cx="842" cy="756.3" r="1.6" />
                  <circle cx="833.9" cy="764.1" r="1.6" />
                  <circle cx="824.3" cy="768" r="1.6" />
                  <circle cx="873.7" cy="776" r="1.5" />
                  <circle cx="868.8" cy="768.1" r="1.6" />
                  <circle cx="864.2" cy="758.5" r="1.6" />
                  <circle cx="859.9" cy="748.6" r="1.6" />
                  <circle cx="849.6" cy="748.4" r="1.6" />
                  <circle cx="840.7" cy="747.8" r="1.6" />
                  <circle cx="848" cy="741" r="1.6" />
                  <circle cx="856.2" cy="739.4" r="1.6" />
                  <circle cx="864.7" cy="741.4" r="1.6" />
                  <circle cx="868.3" cy="751.1" r="1.6" />
                  <circle cx="872.5" cy="760.6" r="1.6" />
                  <circle cx="879.2" cy="769.2" r="1.6" />
                  <circle cx="882.6" cy="777.5" r="1.5" />
                  <circle cx="889.7" cy="772.1" r="1.6" />
                  <circle cx="888.9" cy="764.3" r="1.6" />
                  <circle cx="897.4" cy="765.2" r="1.6" />
                  <circle cx="896" cy="757.3" r="1.6" />
                  <circle cx="904.7" cy="757.5" r="1.6" />
                  <circle cx="902" cy="749.8" r="1.6" />
                  <circle cx="910.7" cy="749.1" r="1.6" />
                  <circle cx="914.7" cy="759" r="1.6" />
                  <circle cx="918.9" cy="768.5" r="1.6" />
                  <circle cx="923" cy="778.1" r="1.6" />
                  <circle cx="928.3" cy="786.7" r="1.5" />
                  <circle cx="937.4" cy="786.1" r="1.5" />
                  <circle cx="932" cy="778.9" r="1.6" />
                  <circle cx="927.1" cy="770.2" r="1.6" />
                  <circle cx="923.2" cy="761" r="1.6" />
                  <circle cx="918.7" cy="752.1" r="1.6" />
                </g>
              </g>
              <g className="squiggle-top">
                <path className="sq-top" d="M403.3,245.7c-3.3.5-6.6-1.7-8.4-4.5s-2.6-6.2-3.5-9.4a67.9,67.9,0,0,0-8.5-18.2c-1.1-1.7-2.6-3.5-4.6-3.9s-3.8.6-5.4,1.7c-8.5,5.6-15,13.9-23,20.3-2,1.6-4.5,3.3-7,2.7s-4.5-3.6-5.6-6.4c-3.5-9-5.6-18.7-11.4-26.4a9.3,9.3,0,0,0-4.6-3.7c-2.6-.7-5.3.5-7.5,2-9.1,5.9-15,16-24.5,21.2a5.8,5.8,0,0,1-5.1.5,7.5,7.5,0,0,1-3-3.4,116.3,116.3,0,0,1-8.3-18.8,33.5,33.5,0,0,0-3.5-8c-1.6-2.4-4.2-4.4-7.1-4.6" style={{fill: 'none', stroke: '#f62c72', strokeLinecap: 'round', strokeMiterlimit: 10, strokeWidth: '12px'}} />
            ...
            <g className={styles.growCrosshairs}>
              <path d="M983.1,582.2h-9v-9a5.9,5.9,0,0,0-11.9,0v9h-9a5.9,5.9,0,1,0,0,11.9h9v9a5.9,5.9,0,0,0,11.9,0v-9h9a5.9,5.9,0,0,0,0-11.9Z" />
            ...
            <g className={styles.topTriangles}>
              <polygon className={styles.topTrianglePolygon} points="593 168.6 659.5 244.5 497.1 255.2 593 168.6" />
              <polyline className={styles.topTrianglePolyline} points="659.5 234.5 657.3 213.9 590.7 138 494.8 224.6 497.1 245.2 497.1 245.2 593 158.6 659.5 234.5" />
            </g>
            
            <g className={styles.words}>
              <text 
                transform="translate(440.5 303.1) rotate(-2.9)" 
                style={{fontSize: '60px'}}
              >
                P
              </text>
              ...
              <text 
                transform="translate(477.5 303.1) rotate(-2.9)" 
                style={{fontSize: '40px'}}
              >
                ágina
              </text>
              ...
              <text 
                transform="translate(489.5 343.1) rotate(-2.9)" 
                style={{fontSize: '30px'}}
              >
                não encontrada
              </text>
